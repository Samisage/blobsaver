...
public final class Devices {
    ...
    private static final ObservableList<String> HomePodList = unmodifiableArrayList("HomePod");

    private static final ObservableList<String> deviceTypes = unmodifiableArrayList("iPhone", "iPod", "iPad", "AppleTV", "HomePod", "T2 Mac");
